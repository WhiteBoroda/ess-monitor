...
typedef struct Config {
  ...
  bool watchdogEnabled = true;   // Watchdog disabled by default (enable via web interface)
  uint8_t watchdogTimeout = 30;   // Watchdog timeout in seconds (default: 60s)
